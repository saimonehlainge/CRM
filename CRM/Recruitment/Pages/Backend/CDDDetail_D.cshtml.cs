...
{
    public class CDDDetail_DModel : PageModel
    {
        private readonly IUnitOfWork _unitOfWork;

        public CDDDetail_DModel(IUnitOfWork unitOfWork)
        {
