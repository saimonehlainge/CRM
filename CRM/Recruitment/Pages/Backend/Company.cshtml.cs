...
namespace Recruitment.Pages.Backend
{
    public class CompanyModel : PageModel
    {
        ...
        public CompanyModel(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IActionResult> OnPostTable()
        {
            try
            {
                ...
                var GetDB = await _unitOfWork.CompanyRepository.GetAllAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> OnPostAddData(RequestDTO.CompanyRequest request)
        {
            var i = 0;
            try
            {
        ...
        [HttpGet]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> OnGetCompany(int? Id)
        {
            var db = await _unitOfWork.CompanyRepository.GetByIdAsync(Id);
            return new JsonResult(db);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> OnPostEditData(RequestDTO.CompanyRequest request)
        {
            var i = 0;
            try
            {
